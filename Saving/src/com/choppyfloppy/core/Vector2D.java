...
public class Vector2D {
     ...
     * Vector2D for example a player. You can give it
     * an initial x and y value to place it where you
     * want on the game-board.
     ...
     * @return a new Vector2D with the wanted x and y values
     */
    ...
    /**
     * Is used to add a x-value to the current x-value of the Vector2D
    ...
    /**
     * Is used to add a y-value to the current y-value of the Vector2D
     * this is used when we want objects to move (velocity)
    ...
    /**
     * Is used to get the x value from a Vector2D. (position)
     */
    public double getX() {
        return x;
    }
    ...
    /**
     * Is used to set the x value of a Vector2D. (position)
     * @param x is a double value
     */
    ...
    /**
     * Is used to get the y value from a Vector2D. (position)
     */
    public double getY() {
        return y;
    }
    ...
    /**
     * Is used to set the y value of a Vector2D. (position)
     * @param y is a double value
     */
