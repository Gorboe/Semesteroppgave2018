...
public abstract class GameObject {
    ...
    /**
     * getImage checks if the image is already saved in the imageMap
     * or not. If it is already in the imageMap it will just return
     * the String location of the image back to updateAnimation.
     * If it is not in the imageMap a new Image will be created
     * and stored.
    ...
    /**
     * Used to update the animations of every GameObject
     ...
     * We can for ie type player.getPosition(); and it will return
    ...
    /**
     * isColliding is used to check if GameObjects is colliding
     * with eachother. In Game class we type: enemy.isColliding(bullet)
     * isColliding will then check the bounds between the GameObject
