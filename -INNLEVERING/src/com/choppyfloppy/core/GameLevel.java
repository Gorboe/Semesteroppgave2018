...
import com.choppyfloppy.util.Content;
...
/**
 * The class GameLevel is used to check for a level change
 * and to change the level. (change background image)
 */
public class GameLevel {
    ...
    /**
     * checkForChange runs 60 times a second to see if
    ...
    /**
     * changeLevel is used to change the level. When
